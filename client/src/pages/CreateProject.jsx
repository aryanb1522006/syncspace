...
export function CreateProject() {
  ...
  return <AppShell>
    ...
    <form className="project-form" onSubmit={submit}>
      ...
      <div className="form-actions"><Button type="button" variant="secondary" onClick={() => navigate('/projects/mine')}>Cancel</Button><Button type="submit" disabled={busy}>{busy ? 'Publishing…' : 'Publish project'}</Button></div>
    </form>
  </AppShell>;
}
