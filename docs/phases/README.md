...
|---|---|---|---|
| 1 | Foundation, migrations, seed, architecture | Complete | Numbered SQL migrations; 50-skill seed; syntax checks |
| 2 | Auth, student profiles, projects | Complete | 5 API-shell tests; syntax checks |
| 3 | Matching and recommendations | Complete | Pure-function unit tests and worked example |
| 4 | Applications, teams, tasks, notifications | Complete | Transactional workflow test |
